...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Teste não passando argumentos. Deverá retornar o objeto com o horário de funcionamento', () => {
  ...
  it('Para os argumentos Friday e 09:00-ZM deve lançar uma exceção com a mensagem: "The abbreviation must be \'AM\' or \'PM\'"', () => {
    const throwMessage = 'The abbreviation must be \'AM\' or \'PM\'';
    expect(() => getOpeningHours('Friday', '09:00-ZM')).toThrow(throwMessage);
  });
